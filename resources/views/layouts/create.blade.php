...
<div class="col-md-12 col-sm-12">
    <div class="form-group mb-3">
      ...
      <input type="number" name="pnumber" class="form-control shadow-none" value="{{ old('pnumber') }}">
    @error('pnumber')
        <p class="text-danger">
        {{ $message }}
        </p>
...
<label for="">Office/Apartemt no.</label>
   <input type="number" name="apartmentNo" class="form-control" value="{{ old('apartmentNo') }}">
@error('apartmentNo')
    <p class="text-danger">
       {{ $message }}
    </p>
